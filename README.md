...
v0.16.0は、演習開始時と問題一覧で「学習分野 → 問題の種類」を統一して選択できるようにした正式Versionです。実端末のGitHub Pages環境で6分類の表示・件数切替を確認済みです。
...
既存共通科目データは、看護協会Eラーニング536問・穴抜き1,917問・予想問題190問、合計2,643問として分類されます。専門科目は正式データImport後に同じ分類体系で利用します。

演習セット作成では問題種類を複数選択でき、選択中の学習分野・問題種類に応じて母集団件数が自動更新されます。
